...
\center{\includegraphics[width=1\linewidth]{getTweetsTime}}
...
\begin{figure}[H] % Example image
\center{\includegraphics[width=1\linewidth]{getStatusesTimeline}}
...
\begin{figure}[H] % Example image
\center{\includegraphics[width=1\linewidth]{informationSelection}}
...
\begin{figure}[H] % Example image
\center{\includegraphics[width=1\linewidth]{statisticsDiv}}
...
\begin{figure}[H] % Example image
\center{\includegraphics[width=1\linewidth]{interpretingTweetStatistics}}
...
\begin{figure}[H] % Example image
\center{\includegraphics[width=1\linewidth]{getStatsHTMLTime}}
\caption{Time to get tweet list from Twitter by using the APIs.}
...
\begin{figure}[H] % Example image
\center{\includegraphics[width=1\linewidth]{EJS}}
\caption{EJS}
\label{EJS}
\end{figure}
...
\begin{figure}[H] % Example image
\center{\includegraphics[width=1\linewidth]{hashtagButton}}
...
\noindent This app uses all the technologies required by the professor, such as HTML5, CSS, JavaScript, AJAX, NodeJS and a cloud platform called Heroku. We will also go more in-depth into the Twitter APIs later.
  ...
  \subsubsection{HTML5  \cite{html5}} All pages are developed in valid HTML5 and they use the HTML5 APIs like, for example, the DOM which can be easily modified by JavaScript code (see Figure 9 for an example).
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{htmlAPI}}
  ...
  \subsubsection{CSS \cite{css}} The presentation of the documents is styled by using CSS files embedded into the HTML files (see Figure 10 for an example).
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{embeddedCSS}}
  ...
  \subsubsection{JavaScript \cite{javascript}} All client-side code is written in JavaScript using either vanilla JavaScript or jQuery.
   ...
   \subsubsection{AJAX  \cite{ajax}} The app uses XMLHttpRequests (Figure 11) to POST form data to the server \cite{ajaxForms} (note that AJAX is the safest and most reliable way to make HTTP requests).
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{AJAX}}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{AJAXserver}}
   ...
   \subsubsection{NodeJS  \cite{nodejs}} The app uses various NodeJS modules that must be installed (Figure 13) like Express, Body-Parser, Path and 2 other files that I wrote and included in the main app file.
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{NodeJS}}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{express}}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{expresslisten}}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{bodyparser}}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{pathStatic}}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=1\linewidth]{twitter}}
	...
	\begin{enumerate}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{trendsAPIv2}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{trendsInterval}}
		\caption{Updating trends every hour.}
		\label{trendsInterval}
		\end{figure}

		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{trendsAPI}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{tweetEndpoint}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{tweetOut}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{getTweetEndpoint}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{getTweet}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=0.7\linewidth]{deprecatedStream}}
		\caption{Twitter replaces streaming APIs.}
		\label{deprecatedStream}
		\end{figure}

		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{activityAPIs}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{accountActivitySteps}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{webhookPOST}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{createWebhook}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{CRCrequirements}}
		\caption{CRC response requirements}
		\label{CRCrequirements}
		\end{figure}

		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{CRCresponse}}
		\caption{CRC response (code).}
		\label{CRCresponse}
		\end{figure}

		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{hashCreation}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{addWebhookSubscription}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{favoriteEventExample}}
		...
		\begin{figure}[H] % Example image
		\center{\includegraphics[width=1\linewidth]{intervalUpdate}}
...
\subsection{First Draft}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=0.6\linewidth]{first_draft}}
...
\subsection{Application API Endpoints}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=0.7\linewidth]{API}}
...
\subsection{MVC example}
	...
	\begin{figure}[H] % Example image
	\center{\includegraphics[width=0.7\linewidth]{MVC}}
